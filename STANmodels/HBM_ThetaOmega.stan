...
model {
  ...
  mu_log_tau    ~ normal(0, 1);     // prior on log tau; implies tau around e^1 ??? 2.7
      ...
      for (rd in 1:nRd) {
        ...
        for (t in 1:nT) {
          if (choice[s,rd,t] != 0) {
            ...
            if (t >= phase2_start) {
              U[1] = (Rmu[s,rd,t,o1] - 0.5) + theta[s] * smu1 + omega[s] * ss1;
              U[2] = (Rmu[s,rd,t,o2] - 0.5) + theta[s] * smu2 + omega[s] * ss2;
              target += categorical_logit_lpmf(choice[s,rd,t] | tau[s] * U);
              ...
              U[1] = (Rmu[s,rd,t,o1] - 0.5);
              U[2] = (Rmu[s,rd,t,o2] - 0.5);
              target += categorical_logit_lpmf(choice[s,rd,t] | tau[s] * U);
            }
          }
        }
        ...
        for (t in 1:nT) {
          if (choice[s,rd,t] != 0) {
            ...
            if (t >= phase2_start) {
              ...
              U[1] = (Rmu[s,rd,t,o1] - 0.5) + theta[s] * smu1 + omega[s] * ss1;
              U[2] = (Rmu[s,rd,t,o2] - 0.5) + theta[s] * smu2 + omega[s] * ss2;
              ll  += categorical_logit_lpmf(choice[s,rd,t] | tau[s] * U);
